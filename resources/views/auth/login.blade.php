                                ...
                                <div class="login-form login-forgot1 pt-11">
                                    ...
                                    <form class="form" novalidate="novalidate" id="kt_login_forgot1_form">
                                        ...
                                        <div class="text-center pb-8">
                                            ...
                                            <p class="text-muted font-weight-bold font-size-h4">أدخل البريد الإلكتروني
                            ...
                            <div class="d-flex flex-column-fluid flex-column flex-center">
                                ...
                                <div class="login-form login-signin2">
                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="form"
                                          novalidate="novalidate" id="kt_login_signin2_form">
                                        @csrf
                                        <!--begin::Title-->
                                        <div class="text-center pb-8">
                                        ...
                                        <!--begin::Form group-->
                                        <div class="form-group">
                                            <label class="font-size-h6 font-weight-bolder text-dark">{{ __('E-Mail Address') }}
                                            </label>
                                ...
                                <div class="login-form login-signup2 pt-11">
                                    ...
                                    <form method="POST" action="{{ route('register') }}" class="form"
                                          novalidate="novalidate" id="kt_login_signup2_form">
                                        @csrf
                                        <!--begin::Title-->
                                        <div class="text-center pb-8">
